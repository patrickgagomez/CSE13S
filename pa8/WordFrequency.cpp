 ...
 * WordFrequency.cpp
 *	The main '.cpp' file for the WordFrequency client.
 *********************************************************************************/
...
int main(int argc, char *argv[]) {
  ...
  while (getline(in, line)) {
    ...
    if (A.contains(tokenBuffer) == true) {
      valType tokenInc = A.getValue(tokenBuffer);
      tokenInc++;
    } else if (A.contains(tokenBuffer) == false) {
